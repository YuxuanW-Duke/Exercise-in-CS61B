...
public class ArrayRingBuffer<T> implements BoundedQueue<T> {
    ...
    public void enqueue(T x) {
        ...
        //       last.
        if(isFull()){
            throw new RuntimeException("The deque is already full.");
        } else {
            rb[last] = x;
    ...
    public T dequeue() {
        ...
        //       update first.
        if(isEmpty()){
            throw new RuntimeException("The deque is now empty.");
        } else {
            T temp = rb[first];
            fillCount -= 1;
    ...
    public boolean equals(Object other) {
        ...
        while (tIterator.hasNext() && oIterator.hasNext()) {
            if (tIterator.next() != oIterator.next()) {
                return false;
            }
        }
        return true;
    ...
    // DONE: Remove all comments that say _ when you're done.
